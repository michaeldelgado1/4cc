...
// TOP
function void
setup_default_global_mapping(Mapping *mapping, i64 global_id){
  MappingScope();
...
function void
setup_default_file_mapping(Mapping *mapping, i64 file_id){
  MappingScope();
  SelectMapping(mapping);

  SelectMap(file_id);
  // NOTE(mdelgado): Why doesn't this have global as a parent?
...
function void
setup_default_code_mapping(Mapping *mapping, i64 file_id, i64 code_id){
  MappingScope();
  SelectMapping(mapping);
...
setup_default_mapping(Mapping *mapping, i64 global_id, i64 file_id, i64 code_id){
  setup_default_global_mapping(mapping, global_id);
  setup_default_file_mapping(mapping, file_id);
  setup_default_code_mapping(mapping, file_id, code_id);
}
